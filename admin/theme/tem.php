<!DOCTYPE html>
<html lang="en">
<a class="link-mask" href="' . web_root . 'admin/stock/index.php">
<head>
    <!-- Title -->
                                ...
                                <ul id="wallets" class="nav nav-v2 nav-primary nav-justified d-block d-xl-flex w-100"
                                    ...
                                    <li class="nav-item border-bottom border-xl-bottom-0 border-xl-left">
                                        <a class="nav-link d-flex align-items-center py-2 px-3 p-xl-4"
                                            href="#bitcoinCash" role="tab" aria-selected="false" data-toggle="tab">
                                            <span>London</span>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-0">
                               ...
                               [69,47,69,53,45,94,34,31,68,73,83,68]
                                        ...
                                        data-is-show-axis-x="false" data-is-show-axis-y="false"
